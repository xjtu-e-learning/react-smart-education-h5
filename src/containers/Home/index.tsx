...
import { clickCom, fetchSubjectData, updatAlertShown,updateSubjectData ,fetchDomainData, updateDomainData ,updateMapShown} from "../../redux/actions";
import {Menu,Typography, Alert, Spin} from 'antd';
...
export default connect(mapStateToProps, {updatAlertShown,clickCom, fetchSubjectData, updateSubjectData, fetchDomainData,updateDomainData,updateMapShown})(Home);